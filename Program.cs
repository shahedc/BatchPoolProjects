...
namespace BatchPoolProjects
{
    ...
    public class Program
    {
        ...
        private static string AuthorityUri = ConfigurationManager.AppSettings["AuthorityUri"];
        private static string BatchResourceUri = ConfigurationManager.AppSettings["BatchResourceUri"];
        private static string ClientId = ConfigurationManager.AppSettings["ClientId"];
        private static string RedirectUri = ConfigurationManager.AppSettings["RedirectUri"];

        // Batch account credentials
        private static string BatchAccountName = ConfigurationManager.AppSettings["BatchAccountName"];
        private static string BatchAccountKey = ConfigurationManager.AppSettings["BatchAccountKey"];
        private static string BatchAccountUrl = ConfigurationManager.AppSettings["BatchAccountUrl"];
        ...
        private static async Task MainAsync()
        {
            ...
            // OLD: BatchSharedKeyCredentials cred = new BatchSharedKeyCredentials(BatchAccountUrl, BatchAccountName, BatchAccountKey);

            // OLD: using (BatchClient batchClient = BatchClient.Open(cred))
